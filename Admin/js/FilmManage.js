...
async function UpdateAllAboutFilm(Movie, formData, formData2){
  ...
  fetch(`${url}/${film}`, {
    ...
    body: JSON.stringify(Movie)
      ...
      else if(!(!updateMovieAdposter.files || updateMovieAdposter.files.length === 0)){
        console.log("Vô AdPoster2");
          fetch(`${url}/${film}/${adsposter}/${idglobal}`, {
            method: 'PUT',
            headers: {
              'Authorization': "bearer " + localStorage.getItem('token')
